...
grep "Average total difference in" logs/test_EFIT01_$shot.log
echo ""
...
grep "Average total difference in" logs/test_EFIT02_$shot.log
echo ""
...
grep "Average total difference in" logs/test_k_to_gfiles_$shot.log
echo ""
