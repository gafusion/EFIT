...
./test_snap.sh $shot "EFIT01" $efit_exe_pub $efit_exe $support_files > logs/test_EFIT01_$shot.log
...
./test_snap.sh $shot "EFIT02" $efit_exe_pub $efit_exe $support_files > logs/test_EFIT02_$shot.log
...
./test_kfiles.sh $shot 'EFIT01' $efit_exe_pub $efit_exe $support_files > logs/test_kfiles_$shot.log
