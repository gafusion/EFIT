...
!vas      		      ltbdir,lindir,lstdir
      character*82 table_dir,input_dir,store_dir
      integer*4	ltbdir,lindir,lstdir
...
!vas for linux      data table_dir /'/u4/radhakri/green/2008/'/
      data input_dir /'/link/efit/'/
      data store_dir /'/link/store/'/
...
!var_consta
     module var_consta 
     public 
     real*8 pi,tmu,twopi, tmu2,errcut, tmu0,radeg 
...
!        to default value of -1
      module profile_ext_mod
        ...
        real*8 :: sign_ext, scalepp_ext, scaleffp_ext
