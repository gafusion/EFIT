...
!----------------------------------------------------------------------
  ...
  510 call maxpsi(xc1,yc1,xc2,yc2,x1,y1,x2,y2,f1,f2,f3,f4,area,psilm, &
                  xtry1,ytry1)
...
!---errors
!---
 1000 write (itty,1010) x(1),x(nw),x2,y(1),y(nh),y2
