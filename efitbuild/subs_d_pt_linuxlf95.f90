...
!vas      SUBROUTINE LIB$WAIT(TIME)
!vas      RETURN
!vas      END
!
! This routine is in libd3
!vas       SUBROUTINE STR$UPCASE(OUT,IN)
!vas       CHARACTER*(*) IN,OUT
!vas       OUT=IN
!vas       RETURN
!vas       END
!
!vas      SUBROUTINE LIB$DATE_TIME(STRING)
!vas      CHARACTER*(*) STRING
!vas      CHARACTER*24 DATETIME,FDATE
!C
!vas      DATETIME=FDATE()
!vas      STRING=DATETIME(1:23)
!C
!vas      RETURN
!vas      END
!      
