...
!
        DO 130 J=1,3
          IERR(J)=0
          IPOINT=DNAME(J)
          !CALL PTDATA(ITYP,NSHOT,SOURCE,iIPOINT,IDAT,IER,IAR,RAR,ASCII,INT16,INT32,REAL32)
          CALL PTDATA(ITYP,NSHOT,%ref(SOURCE),%ref(IPOINT),IDAT,IER,IAR,RAR,ASCII,INT16,INT32,REAL32)
